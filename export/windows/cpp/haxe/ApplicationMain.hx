...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "Pax Hortus", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Pax Hortus";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Pax Hortus", null, { width: 1280, height: 720 });
